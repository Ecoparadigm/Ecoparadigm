...
//       {/* 🔥 HEADING */}
//       <h2 className="text-2xl md:text-4xl font-medium leading-tight max-w-3xl mb-12">
...
//       {/* 🔥 CONTAINER */}
//       <div className="border-2 border-dashed border-gray-300 rounded-2xl overflow-hidden grid md:grid-cols-2">

//         {/* 🔹 LEFT - MISSION */}
//         <div className="p-6 md:p-10 border-b md:border-b-0 md:border-r-2 border-dashed border-gray-300">
...
//             elegant solutions that are good for the client, and good for the planet.
//           </p>

//           {/* Quote Box */}
//           <div className="bg-gray-100 p-4 rounded-lg text-md text-gray-600">
//             <p>
...
//               <span
//                 key={index}
//                 className="bg-gray-100 text-gray-700 text-md px-3 py-1 rounded-md"
//               >
//                 {tag}
//               </span>
//             ))}
