...
const ContactSection = () => {
  return (
    <section className="overflow-x-hidden py-12 sm:py-14 md:py-16 px-4 sm:px-6 md:px-12 lg:px-20 xl:px-28 bg-gradient-to-r from-blue-700 to-green-500">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 items-center">
        {/* LEFT SIDE */}
        <motion.div
          variants={fadeLeft}
        ...
        >
          ...
          <h2 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold mt-3 sm:mt-4 leading-tight">
            Trusted by 600+ clients across India to improve efficiency, reduce
            costs, and achieve sustainability goals.
          </h2>

          <p className="mt-3 sm:mt-4 text-blue-100 text-sm sm:text-base md:text-lg max-w-lg">
            Get an assessment and discover how we can help you achieve your
