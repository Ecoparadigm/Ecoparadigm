    ...
    <footer className="bg-black text-white px-8 md:px-16 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-7 gap-4 px-12">
        ...
        <div>
          ...
          <ul className="space-y-1 text-gray-400 text-sm">
            ...
            <li>
              <Link href="#">Compare Natural STP to Conventional STP’s</Link>
            </li>
            <li>
              <Link href="#">Rainwater Harvesting</Link>
            </li>
            <li>
              <Link href="#">Lake Restoration & Rejuvenation</Link>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-1 text-gray-400 text-sm">
            <li>
              <Link href="#">Net Zero Pathways</Link>
            </li>
            <li>
              <Link href="#">Climate Audits</Link>
            </li>
            <li>
              <Link href="#">ESG Compliance</Link>
            </li>
            <li>
              <Link href="#">Accessibility Audits</Link>
            </li>
          </ul>
        </div>
      ...
      <div className="border-t border-gray-700 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex gap-4 mt-4 md:mt-0">
          <div className="w-8 h-8 border border-gray-500 flex items-center justify-center rounded hover:bg-white hover:text-black transition cursor-pointer">
